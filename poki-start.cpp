...
void starterChoice(string &name, pokimac &starterPoki) {
    ...
    cin >> choice;
	if (choice=="1") {
        starterPoki.name="Bulbizarre";
        starterPoki.health=45;
        starterPoki.level=5;
    }
    if (choice=="2") {
        starterPoki.name="Salamèche";
        starterPoki.health=39;
        starterPoki.level=5;
    }
    if (choice=="3") {
        starterPoki.name="Carapuce";
        starterPoki.health=44;
        starterPoki.level=5;
    }
    system("clear");
    system("cls");
